...
// Exercise 1: ============ use _.compose() to rewrite the function below. Hint:
// _.prop() is curried.
...
// Exercise 2: ============ use _.compose(), _.prop() and _.head() to retrieve the
// name of the first car
var nameOfFirstCar = _.compose(_.prop('name'), _.head);

// Exercise 3: ============ Use the helper function _average to refactor
...
// Exercise 4: ============ Write a function: sanitizeNames() using compose that
// takes an array of cars and returns a list of lowercase and underscored names: e.g:
...
//   map(toLowerCase), map(_underscore), map(_.prop('name'))
// );
...
var trace = _.curry((where, x) => { console.log(where, x); return x; })
